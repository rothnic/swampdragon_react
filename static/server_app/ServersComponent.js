...
require(['React', 'dragon_vanilla', 'datamapper'], function (React, VanillaDragon) {
    ...
    var ServersComponent = React.createClass({
        ...
        onChannelMessage: function (channels, message) {
        ...
        componentWillMount: function () {
            ...
            this.vanillaDragon = VanillaDragon(
                {onopen: this.onOpen, onchannelmessage: this.onChannelMessage});
